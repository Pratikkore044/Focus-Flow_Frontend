...
const Feature = () => {
  ...
  <div className="py-8 px-4 mx-auto max-w-7xl sm:py-16 lg:px-6">
      <div className="max-w-3xl mb-8 lg:mb-16">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Designed for individuals and teams like yours</h2>
          <p className="text-gray-500 sm:text-xl dark:text-gray-400">Our todo app is built to help you stay organized, focused, and productive. Whether you’re managing personal tasks or collaborating with a team.</p>
      </div>
      <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Task Planning</h3>
              <p className="text-gray-500 dark:text-gray-400">Create, organize, and prioritize tasks effortlessly.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Secure & Reliable</h3>
              <p className="text-gray-500 dark:text-gray-400">Your data is handled securely with authenticated access.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Productivity Automation</h3>
              <p className="text-gray-500 dark:text-gray-400">Automate routine task updates and stay notified.</p>
          </div>
      </div>
  </div>
</section>
